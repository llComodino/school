...
const char *enemies[ENEMIES * WORLDS] = {"IronJaw", "Shadowthorn", "Blackfire",
                                         "Virgy",   "Emily",       "Milly"};
...
int main(void) {
  ...
  while (status == ongoing) {
    ...
    case thato:
      ...
      case shadowthorn:
        puts("Impressive! You're still alive even after meeting "
    ...
    case chanda:
      ...
      case virgy:
        puts("You've finally succedeed in killing Virgy the Faithful!\nNow "
             "let's move on to Emily the Vampire\n");
        break;

      case emily:
        puts("Impressive! You're still alive even after meeting Emily!\nI "
             "believe you are ready to fight the final boss\n");
        break;
