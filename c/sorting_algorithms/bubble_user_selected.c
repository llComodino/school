...
void bubble_sort (int * const, size_t, bool (*order)(const int * const, const int * const));
...
void bubble_sort (int * const parr, size_t size, bool (*order)(const int * const, const int * const)) {
...
bool ascend (const int * const pe1, const int * const pe2) {
    return *pe1 > *pe2;
}

bool descend (const int * const pe1, const int * const pe2) {
    return *pe1 < *pe2;
}
