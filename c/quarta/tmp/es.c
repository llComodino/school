 ...
 * Scrivere poi un altro programma che legga e stampi il contento del file precedentemente creato
 * Facendo attenzione a stampare un'intestazione adeguata per tutta la tabella 
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
