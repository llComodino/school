 ...
 *
 * Il vostro programma dovra' essere in grado di gestire i prodotti con i
 * seguenti attributi:
 * - nome
 * - prezzo
...
void add_product(Warehouse *warehouse) {
  ...
  warehouse->products[warehouse->size]
      .name[strlen(warehouse->products[warehouse->size].name) - 1] = '\0';
