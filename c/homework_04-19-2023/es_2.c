...
bool verify(const double *const, const double *const,
            bool (*pfn)(const double *const n1, const double *const n2));
...
bool verify(const double *const pn1, const double *const pn2,
            bool (*pfn)(const double *const, const double *const)) {
  return (*pfn)(pn1, pn2);
}
