// Scrivere un programma per la gestione di una promozione di articoli da vela presso un grossista
// La promozione e' riferita ai guanti che possono essere di tre tipi riportati di seguito con i rispettivi prezzi
// Cotone: $10
// Pelle: $25
// Neoprene: $30
// si gestisca il caso in cui un unico cliente che possa fare un numero di ordini di acquisto a piacere ognuno dei quali e' riferito ad un solo tipo di guanti
// 1. Si richieda all'utente il numero di ordni da inserire
// 2. si calcoli e stampii per ogni tipo di gunto la spesa totale degli ordini ad esso associati
#include <stdio.h>
...
int main(void)
{
    char names[SIZE][BUFFER] = {
        {"Cotton"},
        {"Leather"},
        {"Neophrene"}
    };

    int products[SIZE][SIZE] = {
        {10, 25, 30},
        {0},
        {0}
    };
