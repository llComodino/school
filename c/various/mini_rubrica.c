...
void printList(const char[SIZE][BUFFER], const char[SIZE][BUFFER],
               const char[SIZE][BUFFER], const long long int[SIZE][1]);
...
void printList(const char name[SIZE][BUFFER], const char surname[SIZE][BUFFER],
               const char email[SIZE][BUFFER],
               const long long int phone[SIZE][1]) {
  printf("\n\n");
