// Diego Gila       3Ein
//    
// Scrivere un programma che stampi a schermo la seguente tablla per i numeri da 1 a 256
...
int main()
{
    printf("%9s%15s%15s%20s\n","Decimale:","Binario:","Ottale:","Esadecimale:");        // Tabella con spazi giustificti
    for (int i = 1; i <= 256; i++)
