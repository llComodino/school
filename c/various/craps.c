...
// Nel caso fosse 4,5,6,8,9 o 10 al primo tiro questo sarebbe il punteggio del giocatore
// Per vincere bisogna pareggiare il punteggio con un ulteriore lancio
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
