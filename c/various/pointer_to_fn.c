...
void bubble (short * const work, size_t size, bool (*compare)(const short a, const short b))
{
...
bool asced (const short a, const short b)
{
    return a > b;
}

bool desced (const short a, const short b)
{
    return a < b;
}
