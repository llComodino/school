...
float addizione(float x, float y) { return x + y; }

float sottrazione(float x, float y) { return x - y; }

float moltiplicazione(float x, float y) { return x * y; }

float divisione(float x, float y) { return x / y; }

int resto(int x, int y) { return x % y; }