...
int main(void)
{
    ...
    double distinte[AGENTS][COLUMNS][ELEMENTS] = {
        { {rndPrice(), rndPrice(), rndPrice(), rndPrice(), rndPrice()}, {0}, {0}, {0} },            // First column is for prices
        { {rndPrice(), rndPrice(), rndPrice(), rndPrice(), rndPrice()}, {0}, {0}, {0} },            // Other columns are for totals
        { {rndPrice(), rndPrice(), rndPrice(), rndPrice(), rndPrice()}, {0}, {0}, {0} },            // Initialize the totals to 0
        { {rndPrice(), rndPrice(), rndPrice(), rndPrice(), rndPrice()}, {0}, {0}, {0} }             // Give the prices of the products
    };
