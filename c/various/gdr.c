...
// 2 Giocatori [100 HP]
// Attraverso la libreria stdlib e time utilizzare srand e rand per simulare 3 turni di attacco per un giocatore
// Ogni turno verra' lanciato un dado da 20, il risultato del lancio corrispondera' ai danni inflitti all'avversario
// Nel caso in cui il lancio del dado dia come risultato 20 si avra' un danno raddoppiato
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
